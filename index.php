...
async function loadDashboard() {
  try {
    ...
    if (!routers.length) {
      container.innerHTML = '<div class="col-12 text-center text-muted py-5">Belum ada router terdaftar. <a href="routers.php">Tambah router</a></div>';
      return;
    }
        ...
        <div class="card h-100">
          ...
          <div class="card-footer py-1 px-3">
            <div class="d-flex justify-content-between align-items-center">
              ...
              <a href="routers.php?id=${id}" class="btn btn-sm btn-ghost-secondary py-0">Detail</a>
            </div>
          </div>
        </div>
      </div>`;
